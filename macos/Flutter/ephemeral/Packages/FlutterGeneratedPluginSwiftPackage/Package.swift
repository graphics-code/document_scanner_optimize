...
let package = Package(
    ...
    dependencies: [
        ...
        .package(name: "firebase_messaging", path: "../.packages/firebase_messaging-16.1.1"),
        .package(name: "firebase_core", path: "../.packages/firebase_core-4.4.0"),
        .package(name: "firebase_crashlytics", path: "../.packages/firebase_crashlytics-5.0.7"),
